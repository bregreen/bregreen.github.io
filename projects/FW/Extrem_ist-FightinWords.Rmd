...
```{r load libraries, results='hide', error=FALSE}
...
```{r clean_text, echo=FALSE, results=FALSE, error=FALSE}
...
```{r co_oc1, echo=FALSE, fig.width=6}
...
```{r by_year, echo=FALSE, error=FALSE, fig.width=8}
...
```{r other_graphs, echo=FALSE, fig.width=8}
