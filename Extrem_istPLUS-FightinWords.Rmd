...
### MAIN CODE FROM: https://burtmonroe.github.io/TextAsDataCourse/Tutorials/TADA-FightinWords.nb.html#
...
extrem_NYT.dfm_all <-read.delim("70corr_extremist_9410_NYT.txt", header=TRUE, sep="\t")
set.seed(2217)
