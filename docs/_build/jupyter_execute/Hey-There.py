...
:hidden:
:titlesonly:
:caption: Other Scraping Options
...
demos/beautifulsoup_demo
demos/twitterapi_demo
```
...
Cite Jupyter Book <https://jupyterbook.org/cite.html>
My Personal Website <https://bregreen.github.io/>
